...
export const syntheticCalendarEvents: CalendarEvent[] = [
  ...
  },
  {
    ...
    endTime: new Date(new Date().setDate(new Date().getDate() + 1)).setHours(15, 30, 0, 0),
  ...
  },
  {
    ...
    startTime: new Date(new Date().setDate(new Date().getDate() + 1)).setHours(16, 0, 0, 0),
    endTime: new Date(new Date().setDate(new Date().getDate() + 1)).setHours(17, 0, 0, 0),
  ...
  // This Week
  {
    ...
    endTime: new Date(new Date().setDate(new Date().getDate() + 2)).setHours(12, 0, 0, 0),
  ...
  },
  {
    ...
    endTime: new Date(new Date().setDate(new Date().getDate() + 3)).setHours(16, 0, 0, 0),
  ...
  },
  {
    ...
    startTime: new Date(new Date().setDate(new Date().getDate() + 4)).setHours(15, 0, 0, 0),
    endTime: new Date(new Date().setDate(new Date().getDate() + 4)).setHours(15, 30, 0, 0),
  ...
  // Recurring Focus Blocks
  {
    ...
    startTime: new Date(new Date().setDate(new Date().getDate() + 1)).setHours(9, 0, 0, 0),
    endTime: new Date(new Date().setDate(new Date().getDate() + 1)).setHours(11, 0, 0, 0),
    attendees: ['You'],
  ...
  },
  {
    ...
    startTime: new Date(new Date().setDate(new Date().getDate() + 5)).setHours(13, 0, 0, 0),
    endTime: new Date(new Date().setDate(new Date().getDate() + 5)).setHours(15, 0, 0, 0),
